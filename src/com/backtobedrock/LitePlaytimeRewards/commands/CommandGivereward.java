...
public class CommandGivereward extends AbstractCommand {

    public CommandGivereward(CommandSender cs, String[] args) {
        super(cs, args);
    }
        ...
        switch (this.args.length) {
            ...
            case 2:
                ...
                if (this.checkPermission("givereward")) {
                    if (CommandGivereward.giveRewardCommand(this.cs, this.args[0], this.args[1], true, 1)) {
            ...
            case 3:
                if (this.checkPermission("givereward") && this.checkNumber()) {
                    if (CommandGivereward.giveRewardCommand(cs, args[0], args[1], true, Integer.parseInt(args[2]))) {
            ...
            case 4:
                ...
                if (this.checkPermission("givereward") && this.checkNumber()) {
                    ...
                    if (CommandGivereward.giveRewardCommand(this.cs, this.args[0], this.args[1], Boolean.getBoolean(this.args[3]), Integer.parseInt(this.args[2]))) {
                        this.cs.sendMessage(this.plugin.getMessages().getRewardGiven(this.args[1], this.args[0]));
                    }
                }
                break;
